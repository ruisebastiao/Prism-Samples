...
namespace Factory.MVVM.Bases
{
    ...
    public abstract class ValidatableBindableBase<T> : NotifyBase, INotifyDataErrorInfo//, IDataErrorInfo
        where T : ValidatableBindableBase<T>
    {
        #region Fields
        ...
        protected override bool SetProperty<U>(ref U storage, U value, [CallerMemberName] string propertyName = null)
        {
            var result = base.SetProperty(storage:ref storage,value:value,propertyName:propertyName);
