namespace Factory.MVVM.Validations
{
    ...
    public abstract class NotifyDataErrorInfo<T> : BindableBaseEx, INotifyDataErrorInfo//, IDataErrorInfo
        where T : NotifyDataErrorInfo<T>
    {
        ...
        protected override bool SetProperty<U>(ref U storage, U value,
